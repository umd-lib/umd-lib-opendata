...
def main():
    ...
    for object in response['_embedded']['objects']:
        ...
        # Fetch the item page. rdflib can retrieve a URL itself, given
        ...
        # Extract the item's JSON-LD metadata and add it to the graph. The
    ...
    if len(g) == 0:
        print('No JSON-LD statements were found in the fetched item pages',
              file=sys.stderr)
        sys.exit(1)
